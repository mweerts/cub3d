...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/05 16:27:07 by mweerts           #+#    #+#             */
/*   Updated: 2020/05/02 22:29:07 by mweerts          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static void	sprite_texture(t_storage *s, t_sprite_info *s_i)
{
	int	stripe;
	int	y;
...
static void	draw_sprite(t_sprite_info *s_i, t_sprite *sprite, int *sprite_order,
t_storage *s)
{
...
static void	init_sprite(t_storage *s, t_sprite *sprite, int *sprite_order,
double *sprite_distance)
{
	...
	sort_sprites(sprite_order, sprite_distance, s->info->sprite_nb);
}

void		sprite_management(t_storage *s, t_sprite *sprite, int sprite_nb)
{
